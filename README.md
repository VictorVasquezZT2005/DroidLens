...
1.  **Platform Tools (ADB):** Necesario para la comunicación con el dispositivo Android.
2.  **scrcpy:** La herramienta principal para mostrar y grabar la pantalla.
    - Recomendado instalar vía Homebrew: `brew install scrcpy`

## 🛠️ Instalación y Uso

¡No necesitas configurar código ni instalar dependencias manualmente! 
